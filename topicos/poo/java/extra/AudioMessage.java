...
public class AudioMessage implements Message {
  ...
  private static final String TIPO = "Áudio";

  public AudioMessage(String nomeArquivo, double tamanhoMB, int duracaoSegundos, String autor) {
    this.nomeArquivo = nomeArquivo;
    this.tamanhoMB = tamanhoMB;
    this.duracaoSegundos = duracaoSegundos;
    this.conteudo = "[Áudio: " + nomeArquivo + " (" + String.format("%.2f", tamanhoMB) + 
